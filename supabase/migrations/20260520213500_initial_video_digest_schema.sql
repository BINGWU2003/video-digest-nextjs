...
create table public.delivery_records (
  ...
  constraint delivery_records_status_check check (status in ('queued', 'sent', 'delivered', 'delivery_delayed', 'bounced', 'complained', 'failed', 'cancelled'))
);
...
create unique index delivery_records_provider_message_id_idx
